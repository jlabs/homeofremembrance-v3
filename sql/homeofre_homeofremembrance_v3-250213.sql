...
--
-- Host: localhost
-- Generation Time: Feb 25, 2013 at 11:34 PM
...
CREATE TABLE IF NOT EXISTS `user_vault` (
  ...
  `file_name_wedding` text NOT NULL,
  `file_size_wedding` int(11) NOT NULL DEFAULT '0',
  `file_directory_wedding` text NOT NULL,
  `file_name_birth` text NOT NULL,
  `file_size_birth` int(11) NOT NULL DEFAULT '0',
  `file_directory_birth` text NOT NULL,
  `file_name_insurance` text NOT NULL,
  `file_size_insurance` int(11) NOT NULL DEFAULT '0',
  `file_directory_insurance` text NOT NULL,
  PRIMARY KEY (`VaultID`)
...
INSERT INTO `user_vault` (`VaultID`, `UserID`, `doctor_name`, `doctor_contact`, `funeral`, `resting`, `will`, `additional_info`, `file_name_wedding`, `file_size_wedding`, `file_directory_wedding`, `file_name_birth`, `file_size_birth`, `file_directory_birth`, `file_name_insurance`, `file_size_insurance`, `file_directory_insurance`) VALUES
(1, 1, 'Dr Jeff', 'Fax ... lol', 'Funeral', 'Resting', 'Will', 'Who uses fax?! I mean, really?!', '', 0, '', '', 0, '', '', 0, ''),
(13, 1, 'Dr Jeff', 'Fax ... lol', 'Funeral', 'Resting', 'Will', 'Who uses fax?! I mean, really?!', 'Full Time Application Form 12-13.xsn', 8550, 'users/a87ff679a2f3e71d9181a67b7542122c/vault/wedding/Full Time Application Form 12-13.xsn', 'Key.txt', 29, 'users/a87ff679a2f3e71d9181a67b7542122c/vault/birth/Key.txt', 'lloyds credit card info.txt', 202, 'users/a87ff679a2f3e71d9181a67b7542122c/vault/insurance/lloyds credit card info.txt');
